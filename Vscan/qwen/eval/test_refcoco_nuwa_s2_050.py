...
# from qwen.model.qwen2_5_vl_visionzip import Qwen2_5_VLForConditionalGeneration

from qwen.model.qwen2_5vl_visionzip_s2 import Qwen2_5_VLForConditionalGeneration
...
if __name__ == "__main__":
    ...
    steps = 0
    print("Steps: ", steps)
    MODEL_PATH = "/gpt/hyh/model/Qwen2.5-VL-7B-Instruct"
    ...
    DATA_ROOT = "/gpt/hyh/code/SelfEvolvingAgent/VScan/data/coco2014/rec_jsons_processed" # the refcoco evaluation set is from the VLM-R1 repo
    ...
    TEST_DATASETS = [ 'refcoco_testA', 'refcoco_testB']
    IMAGE_ROOT = "/gpt/hyh/code/SelfEvolvingAgent/VScan/data/coco2014"
    ...
    for ds in TEST_DATASETS:
        ...
        for idx in tqdm(range(0, len(messages_per_device), BSZ)):
            with open("/gpt/hyh/code/SelfEvolvingAgent/VScan/data/eval/RefCOCO/selected_ours.txt", "a") as f:
